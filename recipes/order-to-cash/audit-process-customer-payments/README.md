# Process customer payments Completeness Audit

Audits process customer payments records for completeness and policy compliance against rule-based checks.
...
Reads process customer payments records, runs a rule-based completeness audit, and emits an exceptions workbook.
