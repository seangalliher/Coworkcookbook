---
name: d365-order-to-cash-manage-accounts-receivable
...
# d365-order-to-cash-manage-accounts-receivable

## When to Use

Activate this skill whenever the user's request touches the **Manage accounts receivable** area within **Order to cash**, focused specifically on the Manage accounts receivable L2 area. Specific trigger phrases include:
