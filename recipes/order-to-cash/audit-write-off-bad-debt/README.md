# Write off bad debt Completeness Audit

Audits write off bad debt records for completeness and policy compliance against rule-based checks.
...
Reads write off bad debt records, runs a rule-based completeness audit, and emits an exceptions workbook.
