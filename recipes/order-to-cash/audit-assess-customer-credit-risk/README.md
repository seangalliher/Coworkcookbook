# Assess customer credit risk Completeness Audit

Audits assess customer credit risk records for completeness and policy compliance against rule-based checks.
...
Reads assess customer credit risk records, runs a rule-based completeness audit, and emits an exceptions workbook.
