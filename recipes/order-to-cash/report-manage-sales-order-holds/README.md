# Manage sales order holds Summary Report

Builds a structured summary report of manage sales order holds activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where manage sales order holds stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads manage sales order holds records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Manage sales order holds Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
