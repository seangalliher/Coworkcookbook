# Manage sales order changes Completeness Audit

Audits manage sales order changes records for completeness and policy compliance against rule-based checks.
...
Reads manage sales order changes records, runs a rule-based completeness audit, and emits an exceptions workbook.
