# Monitor customer credit Status Adaptive Card

Produces a reusable Adaptive Card JSON snapshot of monitor customer credit status for embedding in dashboards, emails, or Teams.
...
Gives any consuming app (Teams, Outlook, custom dashboard) a single canonical monitor customer credit status card so different surfaces always show the same numbers.

## What it does

Generates an Adaptive Card JSON file with current monitor customer credit KPIs and RAG indicators.
...
![Placeholder screenshot for Monitor customer credit Status Adaptive Card](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
