# Analyze order management processes Completeness Audit

Audits analyze order management processes records for completeness and policy compliance against rule-based checks.
...
Reads analyze order management processes records, runs a rule-based completeness audit, and emits an exceptions workbook.
