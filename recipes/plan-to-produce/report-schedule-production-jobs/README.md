# Schedule production jobs Summary Report

Builds a structured summary report of schedule production jobs activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where schedule production jobs stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads schedule production jobs records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Schedule production jobs Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
