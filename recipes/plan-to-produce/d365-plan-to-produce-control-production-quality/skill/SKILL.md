---
name: d365-plan-to-produce-control-production-quality
...
# d365-plan-to-produce-control-production-quality

## When to Use

Activate this skill whenever the user's request touches the **Control production quality** area within **Plan to produce**, focused specifically on the Control production quality L2 area. Specific trigger phrases include:
