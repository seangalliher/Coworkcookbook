# Scrap defective production Summary Report

Builds a structured summary report of scrap defective production activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where scrap defective production stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads scrap defective production records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Scrap defective production Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
