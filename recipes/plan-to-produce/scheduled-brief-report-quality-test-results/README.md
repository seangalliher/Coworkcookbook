# Report quality test results Scheduled Email Brief

Schedulable morning-brief email summarizing report quality test results for the responsible owner; designed to run daily or weekly.
...
Replaces a daily manual spreadsheet stitch with an automatic brief so owners walk into standup already knowing where report quality test results stands.

## What it does

Reads report quality test results, computes a short brief, drafts an email, and is a strong candidate for a Cowork scheduled task.
...
![Placeholder screenshot for Report quality test results Scheduled Email Brief](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
