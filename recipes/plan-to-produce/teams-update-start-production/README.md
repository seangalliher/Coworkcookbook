# Start production Teams Channel Update

Drafts a Teams channel post on start production status with an interactive Adaptive Card for quick triage.
...
Reads start production, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Start production Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
