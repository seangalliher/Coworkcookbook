# D365 Plan to produce Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Plan to produce end-to-end process - covers 5 L2 areas and 30 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-plan-to-produce/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-plan-to-produce.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/plan-to-produce/d365-plan-to-produce/skill/dist/d365-plan-to-produce.zip)
2. Extract the archive - you get a folder named `d365-plan-to-produce/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-plan-to-produce`.
