...
> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Cowork/.claude/skills/d365-plan-to-produce/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
