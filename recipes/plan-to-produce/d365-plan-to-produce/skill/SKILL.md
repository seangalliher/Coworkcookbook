...
Activate this skill whenever the user's request touches the **Plan to produce** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
