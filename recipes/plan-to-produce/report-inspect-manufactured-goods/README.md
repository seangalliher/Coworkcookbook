# Inspect manufactured goods Summary Report

Builds a structured summary report of inspect manufactured goods activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where inspect manufactured goods stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads inspect manufactured goods records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Inspect manufactured goods Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
