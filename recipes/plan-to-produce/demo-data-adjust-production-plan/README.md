# Adjust production plan Demo Data Generator

Generates and creates realistic demo records for adjust production plan in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic adjust production plan data in minutes.

## What it does

Generates a configurable number of realistic adjust production plan records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Adjust production plan Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
