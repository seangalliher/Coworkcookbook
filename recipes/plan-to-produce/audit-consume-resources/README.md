# Consume resources Completeness Audit

Audits consume resources records for completeness and policy compliance against rule-based checks.
...
Reads consume resources records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Consume resources Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
