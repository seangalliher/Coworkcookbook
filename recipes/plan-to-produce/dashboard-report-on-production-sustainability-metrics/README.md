# Report on production sustainability metrics Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for report on production sustainability metrics - opens in any browser, no D365 access needed by the viewer.
...
Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing report on production sustainability metrics.
...
![Placeholder screenshot for Report on production sustainability metrics Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
