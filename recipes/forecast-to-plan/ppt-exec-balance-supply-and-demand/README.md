# Balance supply and demand Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on balance supply and demand status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for balance supply and demand reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads balance supply and demand data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Balance supply and demand Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
