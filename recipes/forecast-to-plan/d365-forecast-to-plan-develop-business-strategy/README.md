# D365 Develop business strategy Expert

A Dynamics 365 F&SCM expert scoped to the Develop business strategy area (a level-2 subdomain of Forecast to plan) - covers 10 L3 processes.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-forecast-to-plan-develop-business-strategy/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
**Manual fallback**: navigate to `/Documents/Cowork/skills/` in OneDrive, create a subfolder named `d365-forecast-to-plan-develop-business-strategy`, download `skill/SKILL.md` from the source repo, drop it in.
## How to use
