# Manage financial risks Completeness Audit

Audits manage financial risks records for completeness and policy compliance against rule-based checks.
...
Reads manage financial risks records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Manage financial risks Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
