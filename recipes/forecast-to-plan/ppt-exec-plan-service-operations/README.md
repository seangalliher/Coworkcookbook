# Plan service operations Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on plan service operations status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for plan service operations reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads plan service operations data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Plan service operations Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
