# Develop sales strategy Status Adaptive Card

Produces a reusable Adaptive Card JSON snapshot of develop sales strategy status for embedding in dashboards, emails, or Teams.
...
Gives any consuming app (Teams, Outlook, custom dashboard) a single canonical develop sales strategy status card so different surfaces always show the same numbers.

## What it does

Generates an Adaptive Card JSON file with current develop sales strategy KPIs and RAG indicators.
...
![Placeholder screenshot for Develop sales strategy Status Adaptive Card](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
