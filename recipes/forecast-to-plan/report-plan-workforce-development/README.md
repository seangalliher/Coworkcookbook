# Plan workforce development Summary Report

Builds a structured summary report of plan workforce development activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where plan workforce development stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads plan workforce development records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Plan workforce development Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
