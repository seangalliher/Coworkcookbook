# Project inventory levels Summary Report

Builds a structured summary report of project inventory levels activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where project inventory levels stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads project inventory levels records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Project inventory levels Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
