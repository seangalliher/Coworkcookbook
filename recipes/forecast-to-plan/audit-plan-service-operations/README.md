# Plan service operations Completeness Audit

Audits plan service operations records for completeness and policy compliance against rule-based checks.
...
Reads plan service operations records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Plan service operations Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
