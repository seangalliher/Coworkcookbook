...
> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Cowork/.claude/skills/d365-forecast-to-plan/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
3. Create a subfolder named `d365-forecast-to-plan`.
