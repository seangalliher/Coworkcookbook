# Allocate headcount to business units Teams Channel Update

Drafts a Teams channel post on allocate headcount to business units status with an interactive Adaptive Card for quick triage.
...
Reads allocate headcount to business units, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Allocate headcount to business units Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
