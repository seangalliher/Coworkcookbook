# Balance supply and demand Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for balance supply and demand - opens in any browser, no D365 access needed by the viewer.
...
Lets ops leadership share a live-looking view of balance supply and demand with executives and customers without granting D365 logins.

## What it does

Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing balance supply and demand.
...
![Placeholder screenshot for Balance supply and demand Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
