# Forecast demand Completeness Audit

Audits forecast demand records for completeness and policy compliance against rule-based checks.
...
Reads forecast demand records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Forecast demand Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
