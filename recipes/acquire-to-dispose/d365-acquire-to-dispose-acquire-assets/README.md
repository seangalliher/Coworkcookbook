# D365 Acquire assets Expert

A Dynamics 365 F&SCM expert scoped to the Acquire assets area (a level-2 subdomain of Acquire to dispose) - covers 12 L3 processes.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-acquire-to-dispose-acquire-assets/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-acquire-to-dispose-acquire-assets.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/acquire-to-dispose/d365-acquire-to-dispose-acquire-assets/skill/dist/d365-acquire-to-dispose-acquire-assets.zip)
2. Extract the archive - you get a folder named `d365-acquire-to-dispose-acquire-assets/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-acquire-to-dispose-acquire-assets`.
