# Scrap an asset Completeness Audit

Audits scrap an asset records for completeness and policy compliance against rule-based checks.
...
Reads scrap an asset records, runs a rule-based completeness audit, and emits an exceptions workbook.
