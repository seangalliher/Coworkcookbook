# Improve assets Status Adaptive Card

Produces a reusable Adaptive Card JSON snapshot of improve assets status for embedding in dashboards, emails, or Teams.

## Business value

Gives any consuming app (Teams, Outlook, custom dashboard) a single canonical improve assets status card so different surfaces always show the same numbers.

## What it does

Generates an Adaptive Card JSON file with current improve assets KPIs and RAG indicators.
