# Define leasing policies Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on define leasing policies status, complete with charts and talking-point notes.

## Business value

Cuts deck prep time from hours to minutes for define leasing policies reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads define leasing policies data and produces a 6-8 slide PowerPoint suitable for an executive review.
