# Plan asset leases Completeness Audit

Audits plan asset leases records for completeness and policy compliance against rule-based checks.
...
Reads plan asset leases records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Plan asset leases Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
