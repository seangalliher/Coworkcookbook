# Lease assets Teams Channel Update

Drafts a Teams channel post on lease assets status with an interactive Adaptive Card for quick triage.
...
Reads lease assets, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
