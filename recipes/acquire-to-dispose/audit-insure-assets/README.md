# Insure assets Completeness Audit

Audits insure assets records for completeness and policy compliance against rule-based checks.
...
Reads insure assets records, runs a rule-based completeness audit, and emits an exceptions workbook.
