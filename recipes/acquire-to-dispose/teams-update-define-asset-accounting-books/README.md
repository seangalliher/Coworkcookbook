# Define asset accounting books Teams Channel Update

Drafts a Teams channel post on define asset accounting books status with an interactive Adaptive Card for quick triage.
...
Reads define asset accounting books, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
