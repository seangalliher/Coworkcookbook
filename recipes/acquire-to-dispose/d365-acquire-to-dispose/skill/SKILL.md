...
# d365-acquire-to-dispose

## When to Use

Activate this skill whenever the user's request touches the **Acquire to dispose** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
