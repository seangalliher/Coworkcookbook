# D365 Acquire to dispose Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Acquire to dispose end-to-end process - covers 6 L2 areas and 43 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-acquire-to-dispose/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-acquire-to-dispose.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/acquire-to-dispose/d365-acquire-to-dispose/skill/dist/d365-acquire-to-dispose.zip)
2. Extract the archive - you get a folder named `d365-acquire-to-dispose/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-acquire-to-dispose`.
