# Define leasing policies Completeness Audit

Audits define leasing policies records for completeness and policy compliance against rule-based checks.
...
Reads define leasing policies records, runs a rule-based completeness audit, and emits an exceptions workbook.
