# Transfer assets Teams Channel Update

Drafts a Teams channel post on transfer assets status with an interactive Adaptive Card for quick triage.
...
Reads transfer assets, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
