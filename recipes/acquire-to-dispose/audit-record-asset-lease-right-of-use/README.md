# Record asset lease right-of-use Completeness Audit

Audits record asset lease right-of-use records for completeness and policy compliance against rule-based checks.
...
Reads record asset lease right-of-use records, runs a rule-based completeness audit, and emits an exceptions workbook.
