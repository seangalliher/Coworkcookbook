# Make payments on asset leases Teams Channel Update

Drafts a Teams channel post on make payments on asset leases status with an interactive Adaptive Card for quick triage.
...
Reads make payments on asset leases, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
