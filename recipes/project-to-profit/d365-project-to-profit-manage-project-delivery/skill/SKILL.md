---
name: d365-project-to-profit-manage-project-delivery
...
# d365-project-to-profit-manage-project-delivery

## When to Use

Activate this skill whenever the user's request touches the **Manage project delivery** area within **Project to profit**, focused specifically on the Manage project delivery L2 area. Specific trigger phrases include:
