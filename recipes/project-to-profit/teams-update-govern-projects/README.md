# Govern projects Teams Channel Update

Drafts a Teams channel post on govern projects status with an interactive Adaptive Card for quick triage.
...
Reads govern projects, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Govern projects Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
