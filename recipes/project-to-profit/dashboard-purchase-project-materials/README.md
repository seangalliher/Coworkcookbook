# Purchase project materials Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for purchase project materials - opens in any browser, no D365 access needed by the viewer.
...
Lets ops leadership share a live-looking view of purchase project materials with executives and customers without granting D365 logins.

## What it does

Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing purchase project materials.
...
![Placeholder screenshot for Purchase project materials Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
