# Govern projects Summary Report

Builds a structured summary report of govern projects activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where govern projects stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads govern projects records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Govern projects Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
