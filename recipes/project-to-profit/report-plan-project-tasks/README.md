# Plan project tasks Summary Report

Builds a structured summary report of plan project tasks activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where plan project tasks stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads plan project tasks records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Plan project tasks Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
