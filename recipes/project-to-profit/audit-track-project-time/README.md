# Track project time Completeness Audit

Audits track project time records for completeness and policy compliance against rule-based checks.
...
Reads track project time records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Track project time Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
