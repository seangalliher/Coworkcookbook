# Negotiate project contracts Summary Report

Builds a structured summary report of negotiate project contracts activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where negotiate project contracts stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads negotiate project contracts records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Negotiate project contracts Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
