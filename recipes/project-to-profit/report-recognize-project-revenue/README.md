# Recognize project revenue Summary Report

Builds a structured summary report of recognize project revenue activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where recognize project revenue stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads recognize project revenue records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Recognize project revenue Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
