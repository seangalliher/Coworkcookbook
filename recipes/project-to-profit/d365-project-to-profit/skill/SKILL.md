...
# d365-project-to-profit

## When to Use

Activate this skill whenever the user's request touches the **Project to profit** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
