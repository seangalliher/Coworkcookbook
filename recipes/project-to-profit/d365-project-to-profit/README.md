...
1. [Download `d365-project-to-profit.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/project-to-profit/d365-project-to-profit/skill/dist/d365-project-to-profit.zip)
2. Extract the archive - you get a folder named `d365-project-to-profit/` containing `SKILL.md`.
