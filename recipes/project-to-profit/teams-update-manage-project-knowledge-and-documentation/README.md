# Manage project knowledge and documentation Teams Channel Update

Drafts a Teams channel post on manage project knowledge and documentation status with an interactive Adaptive Card for quick triage.
...
Reads manage project knowledge and documentation, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Manage project knowledge and documentation Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
