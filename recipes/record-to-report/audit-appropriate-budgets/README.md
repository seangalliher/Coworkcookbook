# Appropriate budgets Completeness Audit

Audits appropriate budgets records for completeness and policy compliance against rule-based checks.
...
Reads appropriate budgets records, runs a rule-based completeness audit, and emits an exceptions workbook.
