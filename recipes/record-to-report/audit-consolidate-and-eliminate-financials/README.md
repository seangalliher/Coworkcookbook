# Consolidate and eliminate financials Completeness Audit

Audits consolidate and eliminate financials records for completeness and policy compliance against rule-based checks.
...
Reads consolidate and eliminate financials records, runs a rule-based completeness audit, and emits an exceptions workbook.
