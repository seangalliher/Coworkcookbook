# Develop tax strategy Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for develop tax strategy - opens in any browser, no D365 access needed by the viewer.

## Business value

Lets ops leadership share a live-looking view of develop tax strategy with executives and customers without granting D365 logins.

## What it does

Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing develop tax strategy.
