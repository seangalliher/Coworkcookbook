# Develop chart of accounts strategy Completeness Audit

Audits develop chart of accounts strategy records for completeness and policy compliance against rule-based checks.
...
Reads develop chart of accounts strategy records, runs a rule-based completeness audit, and emits an exceptions workbook.
