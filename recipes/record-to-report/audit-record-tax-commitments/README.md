# Record tax commitments Completeness Audit

Audits record tax commitments records for completeness and policy compliance against rule-based checks.
...
Reads record tax commitments records, runs a rule-based completeness audit, and emits an exceptions workbook.
