# Plan budgets Teams Channel Update

Drafts a Teams channel post on plan budgets status with an interactive Adaptive Card for quick triage.
...
Reads plan budgets, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Plan budgets Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
