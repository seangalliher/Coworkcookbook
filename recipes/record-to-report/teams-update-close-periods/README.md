# Close periods Teams Channel Update

Drafts a Teams channel post on close periods status with an interactive Adaptive Card for quick triage.
...
Reads close periods, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
