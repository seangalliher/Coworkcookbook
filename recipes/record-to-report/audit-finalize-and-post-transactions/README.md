# Finalize and post transactions Completeness Audit

Audits finalize and post transactions records for completeness and policy compliance against rule-based checks.
...
Reads finalize and post transactions records, runs a rule-based completeness audit, and emits an exceptions workbook.
