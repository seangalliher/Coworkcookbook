# Track cash position Summary Report

Builds a structured summary report of track cash position activity with totals, trends, and breakdowns.

## Business value

Gives leadership a fast, repeatable view of where track cash position stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads track cash position records, computes summary statistics and groupings, and emits an Excel report.
