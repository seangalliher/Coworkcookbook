...
**Manual fallback**: navigate to `/Documents/Cowork/skills/` in OneDrive, create a subfolder named `d365-record-to-report-define-accounting-policies`, download `skill/SKILL.md` from the source repo, drop it in.
## How to use
