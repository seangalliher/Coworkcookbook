# D365 Define accounting policies Expert

A Dynamics 365 F&SCM expert scoped to the Define accounting policies area (a level-2 subdomain of Record to report) - covers 10 L3 processes.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-record-to-report-define-accounting-policies/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-record-to-report-define-accounting-policies.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/record-to-report/d365-record-to-report-define-accounting-policies/skill/dist/d365-record-to-report-define-accounting-policies.zip)
2. Extract the archive - you get a folder named `d365-record-to-report-define-accounting-policies/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-record-to-report-define-accounting-policies`.
