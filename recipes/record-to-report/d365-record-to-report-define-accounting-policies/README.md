...
> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Cowork/.claude/skills/d365-record-to-report-define-accounting-policies/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
