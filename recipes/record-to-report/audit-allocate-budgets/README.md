# Allocate budgets Completeness Audit

Audits allocate budgets records for completeness and policy compliance against rule-based checks.
...
Reads allocate budgets records, runs a rule-based completeness audit, and emits an exceptions workbook.
