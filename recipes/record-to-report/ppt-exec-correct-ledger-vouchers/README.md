# Correct ledger vouchers Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on correct ledger vouchers status, complete with charts and talking-point notes.

## Business value

Cuts deck prep time from hours to minutes for correct ledger vouchers reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads correct ledger vouchers data and produces a 6-8 slide PowerPoint suitable for an executive review.
