# Manage funds Teams Channel Update

Drafts a Teams channel post on manage funds status with an interactive Adaptive Card for quick triage.
...
Reads manage funds, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
