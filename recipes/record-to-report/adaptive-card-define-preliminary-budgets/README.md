# Define preliminary budgets Status Adaptive Card

Produces a reusable Adaptive Card JSON snapshot of define preliminary budgets status for embedding in dashboards, emails, or Teams.
...
Gives any consuming app (Teams, Outlook, custom dashboard) a single canonical define preliminary budgets status card so different surfaces always show the same numbers.

## What it does

Generates an Adaptive Card JSON file with current define preliminary budgets KPIs and RAG indicators.
...
![Placeholder screenshot for Define preliminary budgets Status Adaptive Card](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
