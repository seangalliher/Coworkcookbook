# Record cost accounting transactions Completeness Audit

Audits record cost accounting transactions records for completeness and policy compliance against rule-based checks.
...
Reads record cost accounting transactions records, runs a rule-based completeness audit, and emits an exceptions workbook.
