# Reconcile ledger and subledger Teams Channel Update

Drafts a Teams channel post on reconcile ledger and subledger status with an interactive Adaptive Card for quick triage.
...
Reads reconcile ledger and subledger, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
