# Forecast cash flow Completeness Audit

Audits forecast cash flow records for completeness and policy compliance against rule-based checks.
...
Reads forecast cash flow records, runs a rule-based completeness audit, and emits an exceptions workbook.
