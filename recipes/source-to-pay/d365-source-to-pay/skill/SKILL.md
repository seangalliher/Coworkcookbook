...
Activate this skill whenever the user's request touches the **Source to pay** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
