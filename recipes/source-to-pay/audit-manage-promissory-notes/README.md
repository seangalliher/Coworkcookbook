# Manage promissory notes Completeness Audit

Audits manage promissory notes records for completeness and policy compliance against rule-based checks.
...
Reads manage promissory notes records, runs a rule-based completeness audit, and emits an exceptions workbook.
