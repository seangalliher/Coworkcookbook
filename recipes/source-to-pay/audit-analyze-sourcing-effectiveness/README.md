# Analyze sourcing effectiveness Completeness Audit

Audits analyze sourcing effectiveness records for completeness and policy compliance against rule-based checks.
...
Reads analyze sourcing effectiveness records, runs a rule-based completeness audit, and emits an exceptions workbook.
