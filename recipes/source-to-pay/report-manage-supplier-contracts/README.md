# Manage supplier contracts Summary Report

Builds a structured summary report of manage supplier contracts activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where manage supplier contracts stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads manage supplier contracts records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Manage supplier contracts Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
