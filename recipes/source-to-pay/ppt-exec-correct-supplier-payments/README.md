# Correct supplier payments Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on correct supplier payments status, complete with charts and talking-point notes.

## Business value

Cuts deck prep time from hours to minutes for correct supplier payments reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads correct supplier payments data and produces a 6-8 slide PowerPoint suitable for an executive review.
