# Process supplier invoices Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on process supplier invoices status, complete with charts and talking-point notes.

## Business value

Cuts deck prep time from hours to minutes for process supplier invoices reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads process supplier invoices data and produces a 6-8 slide PowerPoint suitable for an executive review.
