# Evaluate supplier bids Completeness Audit

Audits evaluate supplier bids records for completeness and policy compliance against rule-based checks.
...
Reads evaluate supplier bids records, runs a rule-based completeness audit, and emits an exceptions workbook.
