# Onboard new suppliers Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on onboard new suppliers status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for onboard new suppliers reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads onboard new suppliers data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Onboard new suppliers Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
