# Contract suppliers for goods Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on contract suppliers for goods status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for contract suppliers for goods reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads contract suppliers for goods data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Contract suppliers for goods Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
