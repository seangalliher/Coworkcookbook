# Develop procurement catalogs Completeness Audit

Audits develop procurement catalogs records for completeness and policy compliance against rule-based checks.
...
Reads develop procurement catalogs records, runs a rule-based completeness audit, and emits an exceptions workbook.
