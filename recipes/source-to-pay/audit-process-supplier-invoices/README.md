# Process supplier invoices Completeness Audit

Audits process supplier invoices records for completeness and policy compliance against rule-based checks.
...
Reads process supplier invoices records, runs a rule-based completeness audit, and emits an exceptions workbook.
