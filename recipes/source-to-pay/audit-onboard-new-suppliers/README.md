# Onboard new suppliers Completeness Audit

Audits onboard new suppliers records for completeness and policy compliance against rule-based checks.
...
Reads onboard new suppliers records, runs a rule-based completeness audit, and emits an exceptions workbook.
