...
**Manual fallback**: navigate to `/Documents/Cowork/skills/` in OneDrive, create a subfolder named `d365-source-to-pay-manage-supplier-relationships`, download `skill/SKILL.md` from the source repo, drop it in.
## How to use
