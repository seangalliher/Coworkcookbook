# D365 Manage supplier relationships Expert

A Dynamics 365 F&SCM expert scoped to the Manage supplier relationships area (a level-2 subdomain of Source to pay) - covers 8 L3 processes.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-source-to-pay-manage-supplier-relationships/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-source-to-pay-manage-supplier-relationships.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/source-to-pay/d365-source-to-pay-manage-supplier-relationships/skill/dist/d365-source-to-pay-manage-supplier-relationships.zip)
2. Extract the archive - you get a folder named `d365-source-to-pay-manage-supplier-relationships/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-source-to-pay-manage-supplier-relationships`.
