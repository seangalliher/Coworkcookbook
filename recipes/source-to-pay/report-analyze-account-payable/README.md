# Analyze account payable Summary Report

Builds a structured summary report of analyze account payable activity with totals, trends, and breakdowns.

## Business value

Gives leadership a fast, repeatable view of where analyze account payable stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads analyze account payable records, computes summary statistics and groupings, and emits an Excel report.
