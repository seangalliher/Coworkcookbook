# Measure and analyze procurement spend Teams Channel Update

Drafts a Teams channel post on measure and analyze procurement spend status with an interactive Adaptive Card for quick triage.
...
Reads measure and analyze procurement spend, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
