...
# d365-concept-to-market-prepare-marketing-campaigns

## When to Use

Activate this skill whenever the user's request touches the **Prepare marketing campaigns** area within **Concept to market**, focused specifically on the Prepare marketing campaigns L2 area. Specific trigger phrases include:
