# Identify target markets Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for identify target markets - opens in any browser, no D365 access needed by the viewer.
...
Lets ops leadership share a live-looking view of identify target markets with executives and customers without granting D365 logins.

## What it does

Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing identify target markets.
...
![Placeholder screenshot for Identify target markets Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
