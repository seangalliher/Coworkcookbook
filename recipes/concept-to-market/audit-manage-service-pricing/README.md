# Manage service pricing Completeness Audit

Audits manage service pricing records for completeness and policy compliance against rule-based checks.
...
Reads manage service pricing records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Manage service pricing Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
