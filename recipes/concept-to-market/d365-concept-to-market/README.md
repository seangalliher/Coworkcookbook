# D365 Concept to market Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Concept to market end-to-end process - covers 6 L2 areas and 31 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-concept-to-market/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-concept-to-market.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/concept-to-market/d365-concept-to-market/skill/dist/d365-concept-to-market.zip)
2. Extract the archive - you get a folder named `d365-concept-to-market/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-concept-to-market`.
