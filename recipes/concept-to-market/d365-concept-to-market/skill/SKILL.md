...
# d365-concept-to-market

## When to Use

Activate this skill whenever the user's request touches the **Concept to market** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
