# Develop loyalty programs Completeness Audit

Audits develop loyalty programs records for completeness and policy compliance against rule-based checks.
...
Reads develop loyalty programs records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Develop loyalty programs Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
