# Create website for campaigns Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on create website for campaigns status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for create website for campaigns reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads create website for campaigns data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Create website for campaigns Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
