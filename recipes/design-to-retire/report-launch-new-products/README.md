# Launch new products Summary Report

Builds a structured summary report of launch new products activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where launch new products stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads launch new products records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Launch new products Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
