# Manage product compliance Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for manage product compliance - opens in any browser, no D365 access needed by the viewer.
...
Lets ops leadership share a live-looking view of manage product compliance with executives and customers without granting D365 logins.

## What it does

Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing manage product compliance.
...
![Placeholder screenshot for Manage product compliance Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
