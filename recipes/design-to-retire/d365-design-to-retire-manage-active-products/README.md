...
> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-design-to-retire-manage-active-products/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-design-to-retire-manage-active-products.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/design-to-retire/d365-design-to-retire-manage-active-products/skill/dist/d365-design-to-retire-manage-active-products.zip)
2. Extract the archive - you get a folder named `d365-design-to-retire-manage-active-products/` containing `SKILL.md`.
