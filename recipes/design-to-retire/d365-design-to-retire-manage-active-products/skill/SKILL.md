---
name: d365-design-to-retire-manage-active-products
...
# d365-design-to-retire-manage-active-products

## When to Use

Activate this skill whenever the user's request touches the **Manage active products** area within **Design to retire**, focused specifically on the Manage active products L2 area. Specific trigger phrases include:
