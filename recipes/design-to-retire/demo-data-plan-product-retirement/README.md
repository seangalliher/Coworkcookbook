# Plan product retirement Demo Data Generator

Generates and creates realistic demo records for plan product retirement in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic plan product retirement data in minutes.

## What it does

Generates a configurable number of realistic plan product retirement records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Plan product retirement Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
