# Research new products Summary Report

Builds a structured summary report of research new products activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where research new products stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads research new products records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Research new products Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
