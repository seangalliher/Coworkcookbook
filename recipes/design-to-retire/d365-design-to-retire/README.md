# D365 Design to retire Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Design to retire end-to-end process - covers 5 L2 areas and 31 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-design-to-retire/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-design-to-retire.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/design-to-retire/d365-design-to-retire/skill/dist/d365-design-to-retire.zip)
2. Extract the archive - you get a folder named `d365-design-to-retire/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-design-to-retire`.
