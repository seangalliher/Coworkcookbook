# Record employee absences Summary Report

Builds a structured summary report of record employee absences activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where record employee absences stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads record employee absences records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Record employee absences Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
