# Conduct exit interviews Status Adaptive Card

Produces a reusable Adaptive Card JSON snapshot of conduct exit interviews status for embedding in dashboards, emails, or Teams.
...
Gives any consuming app (Teams, Outlook, custom dashboard) a single canonical conduct exit interviews status card so different surfaces always show the same numbers.

## What it does

Generates an Adaptive Card JSON file with current conduct exit interviews KPIs and RAG indicators.
...
![Placeholder screenshot for Conduct exit interviews Status Adaptive Card](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
