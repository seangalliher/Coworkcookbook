# Develop leave and absence policies Completeness Audit

Audits develop leave and absence policies records for completeness and policy compliance against rule-based checks.
...
Reads develop leave and absence policies records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Develop leave and absence policies Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
