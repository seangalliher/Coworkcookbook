# Pay employees Completeness Audit

Audits pay employees records for completeness and policy compliance against rule-based checks.
...
Reads pay employees records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Pay employees Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
