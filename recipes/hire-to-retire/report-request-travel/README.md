# Request travel Summary Report

Builds a structured summary report of request travel activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where request travel stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads request travel records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Request travel Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
