# List open positions Summary Report

Builds a structured summary report of list open positions activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where list open positions stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads list open positions records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for List open positions Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
