# Define employee career paths Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on define employee career paths status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for define employee career paths reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads define employee career paths data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Define employee career paths Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
