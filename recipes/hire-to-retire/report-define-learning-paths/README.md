# Define learning paths Summary Report

Builds a structured summary report of define learning paths activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where define learning paths stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads define learning paths records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Define learning paths Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
