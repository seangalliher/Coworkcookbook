# D365 Hire to retire Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Hire to retire end-to-end process - covers 8 L2 areas and 55 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-hire-to-retire/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-hire-to-retire.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/hire-to-retire/d365-hire-to-retire/skill/dist/d365-hire-to-retire.zip)
2. Extract the archive - you get a folder named `d365-hire-to-retire/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-hire-to-retire`.
