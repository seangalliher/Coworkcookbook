# Cross dock received goods to outbound orders Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for cross dock received goods to outbound orders - opens in any browser, no D365 access needed by the viewer.
...
Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing cross dock received goods to outbound orders.
...
![Placeholder screenshot for Cross dock received goods to outbound orders Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
