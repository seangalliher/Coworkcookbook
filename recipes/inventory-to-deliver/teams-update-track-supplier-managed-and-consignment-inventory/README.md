# Track supplier managed and consignment inventory Teams Channel Update

Drafts a Teams channel post on track supplier managed and consignment inventory status with an interactive Adaptive Card for quick triage.
...
Reads track supplier managed and consignment inventory, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Track supplier managed and consignment inventory Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
