# Reconcile freight Summary Report

Builds a structured summary report of reconcile freight activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where reconcile freight stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads reconcile freight records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Reconcile freight Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
