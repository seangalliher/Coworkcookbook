# Stage inventory Completeness Audit

Audits stage inventory records for completeness and policy compliance against rule-based checks.
...
Reads stage inventory records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Stage inventory Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
