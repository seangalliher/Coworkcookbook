# Rate loads Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on rate loads status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for rate loads reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads rate loads data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Rate loads Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
