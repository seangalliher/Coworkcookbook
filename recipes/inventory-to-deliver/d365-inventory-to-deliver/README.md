# D365 Inventory to deliver Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Inventory to deliver end-to-end process - covers 7 L2 areas and 41 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-inventory-to-deliver/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-inventory-to-deliver.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/inventory-to-deliver/d365-inventory-to-deliver/skill/dist/d365-inventory-to-deliver.zip)
2. Extract the archive - you get a folder named `d365-inventory-to-deliver/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-inventory-to-deliver`.
