# Stage inventory Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on stage inventory status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for stage inventory reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads stage inventory data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Stage inventory Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
