# D365 Manage inventory quality Expert

A Dynamics 365 F&SCM expert scoped to the Manage inventory quality area (a level-2 subdomain of Inventory to deliver) - covers 8 L3 processes.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-inventory-to-deliver-manage-inventory-quality/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-inventory-to-deliver-manage-inventory-quality.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/inventory-to-deliver/d365-inventory-to-deliver-manage-inventory-quality/skill/dist/d365-inventory-to-deliver-manage-inventory-quality.zip)
2. Extract the archive - you get a folder named `d365-inventory-to-deliver-manage-inventory-quality/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-inventory-to-deliver-manage-inventory-quality`.
