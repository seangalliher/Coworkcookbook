...
> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Cowork/.claude/skills/d365-inventory-to-deliver-manage-inventory-quality/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
