# Route loads Teams Channel Update

Drafts a Teams channel post on route loads status with an interactive Adaptive Card for quick triage.
...
Reads route loads, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Route loads Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
