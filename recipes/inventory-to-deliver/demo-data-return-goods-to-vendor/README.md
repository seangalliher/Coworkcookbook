# Return goods to vendor Demo Data Generator

Generates and creates realistic demo records for return goods to vendor in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic return goods to vendor data in minutes.

## What it does

Generates a configurable number of realistic return goods to vendor records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Return goods to vendor Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
