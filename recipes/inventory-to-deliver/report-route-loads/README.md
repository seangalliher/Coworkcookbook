# Route loads Summary Report

Builds a structured summary report of route loads activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where route loads stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads route loads records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Route loads Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
