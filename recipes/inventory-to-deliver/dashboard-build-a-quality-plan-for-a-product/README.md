# Build a quality plan for a product Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for build a quality plan for a product - opens in any browser, no D365 access needed by the viewer.
...
Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing build a quality plan for a product.
...
![Placeholder screenshot for Build a quality plan for a product Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
