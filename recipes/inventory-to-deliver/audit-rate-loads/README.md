# Rate loads Completeness Audit

Audits rate loads records for completeness and policy compliance against rule-based checks.
...
Reads rate loads records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Rate loads Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
