# Renew software licenses Summary Report

Builds a structured summary report of renew software licenses activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where renew software licenses stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads renew software licenses records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Renew software licenses Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
