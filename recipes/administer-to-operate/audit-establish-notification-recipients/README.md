# Establish notification recipients Completeness Audit

Audits establish notification recipients records for completeness and policy compliance against rule-based checks.
...
Reads establish notification recipients records, runs a rule-based completeness audit, and emits an exceptions workbook.
