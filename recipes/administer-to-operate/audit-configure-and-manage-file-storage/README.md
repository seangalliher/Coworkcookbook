# Configure and manage file storage Completeness Audit

Audits configure and manage file storage records for completeness and policy compliance against rule-based checks.
...
Reads configure and manage file storage records, runs a rule-based completeness audit, and emits an exceptions workbook.
