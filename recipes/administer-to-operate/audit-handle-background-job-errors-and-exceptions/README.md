# Handle background job errors and exceptions Completeness Audit

Audits handle background job errors and exceptions records for completeness and policy compliance against rule-based checks.
...
Reads handle background job errors and exceptions records, runs a rule-based completeness audit, and emits an exceptions workbook.
