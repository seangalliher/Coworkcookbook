# Configure and manage copilot capabilities Completeness Audit

Audits configure and manage copilot capabilities records for completeness and policy compliance against rule-based checks.
...
Reads configure and manage copilot capabilities records, runs a rule-based completeness audit, and emits an exceptions workbook.
