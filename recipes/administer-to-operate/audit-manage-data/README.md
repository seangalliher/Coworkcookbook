# Manage data Completeness Audit

Audits manage data records for completeness and policy compliance against rule-based checks.
...
Reads manage data records, runs a rule-based completeness audit, and emits an exceptions workbook.
