# Manage the initial synchronization of data Completeness Audit

Audits manage the initial synchronization of data records for completeness and policy compliance against rule-based checks.
...
Reads manage the initial synchronization of data records, runs a rule-based completeness audit, and emits an exceptions workbook.
