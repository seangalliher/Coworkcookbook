# Configure and manage reporting and analytics Demo Data Generator

Generates and creates realistic demo records for configure and manage reporting and analytics in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic configure and manage reporting and analytics data in minutes.

## What it does

Generates a configurable number of realistic configure and manage reporting and analytics records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Configure and manage reporting and analytics Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
