# Establish support procedures and policies Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for establish support procedures and policies - opens in any browser, no D365 access needed by the viewer.
...
Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing establish support procedures and policies.
...
![Placeholder screenshot for Establish support procedures and policies Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
