# Conduct root cause analysis Summary Report

Builds a structured summary report of conduct root cause analysis activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where conduct root cause analysis stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads conduct root cause analysis records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Conduct root cause analysis Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
