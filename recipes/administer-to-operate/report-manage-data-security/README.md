# Manage data security Summary Report

Builds a structured summary report of manage data security activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where manage data security stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads manage data security records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Manage data security Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
