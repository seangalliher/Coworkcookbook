# Detect asynchronous integrations failures Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for detect asynchronous integrations failures - opens in any browser, no D365 access needed by the viewer.
...
Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing detect asynchronous integrations failures.
...
![Placeholder screenshot for Detect asynchronous integrations failures Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
