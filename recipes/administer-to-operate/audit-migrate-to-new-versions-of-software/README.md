# Migrate to new versions of software Completeness Audit

Audits migrate to new versions of software records for completeness and policy compliance against rule-based checks.
...
Reads migrate to new versions of software records, runs a rule-based completeness audit, and emits an exceptions workbook.
