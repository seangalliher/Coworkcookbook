# Onboard new users Completeness Audit

Audits onboard new users records for completeness and policy compliance against rule-based checks.
...
Reads onboard new users records, runs a rule-based completeness audit, and emits an exceptions workbook.
