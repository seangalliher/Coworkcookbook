# Plan software releases Completeness Audit

Audits plan software releases records for completeness and policy compliance against rule-based checks.
...
Reads plan software releases records, runs a rule-based completeness audit, and emits an exceptions workbook.
