# Migrate to new versions of software Demo Data Generator

Generates and creates realistic demo records for migrate to new versions of software in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic migrate to new versions of software data in minutes.

## What it does

Generates a configurable number of realistic migrate to new versions of software records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Migrate to new versions of software Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
