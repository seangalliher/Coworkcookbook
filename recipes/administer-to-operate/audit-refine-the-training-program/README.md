# Refine the training program Completeness Audit

Audits refine the training program records for completeness and policy compliance against rule-based checks.
...
Reads refine the training program records, runs a rule-based completeness audit, and emits an exceptions workbook.
