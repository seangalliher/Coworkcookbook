# D365 Administer to operate Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Administer to operate end-to-end process - covers 13 L2 areas and 132 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-administer-to-operate/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-administer-to-operate.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/administer-to-operate/d365-administer-to-operate/skill/dist/d365-administer-to-operate.zip)
2. Extract the archive - you get a folder named `d365-administer-to-operate/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-administer-to-operate`.
