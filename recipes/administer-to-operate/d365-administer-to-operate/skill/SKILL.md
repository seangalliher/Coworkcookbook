...
# d365-administer-to-operate

## When to Use

Activate this skill whenever the user's request touches the **Administer to operate** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
