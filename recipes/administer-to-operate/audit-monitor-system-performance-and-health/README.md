# Monitor system performance and health Completeness Audit

Audits monitor system performance and health records for completeness and policy compliance against rule-based checks.
...
Reads monitor system performance and health records, runs a rule-based completeness audit, and emits an exceptions workbook.
