# Track and analyze software licenses Completeness Audit

Audits track and analyze software licenses records for completeness and policy compliance against rule-based checks.
...
Reads track and analyze software licenses records, runs a rule-based completeness audit, and emits an exceptions workbook.
