# Revoke users access to systems Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on revoke users access to systems status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for revoke users access to systems reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads revoke users access to systems data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Revoke users access to systems Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
