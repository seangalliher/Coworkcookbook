# Establish compliance policies and procedures Demo Data Generator

Generates and creates realistic demo records for establish compliance policies and procedures in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic establish compliance policies and procedures data in minutes.

## What it does

Generates a configurable number of realistic establish compliance policies and procedures records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Establish compliance policies and procedures Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
