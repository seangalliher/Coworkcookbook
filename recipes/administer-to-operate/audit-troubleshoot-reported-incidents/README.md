# Troubleshoot reported incidents Completeness Audit

Audits troubleshoot reported incidents records for completeness and policy compliance against rule-based checks.
...
Reads troubleshoot reported incidents records, runs a rule-based completeness audit, and emits an exceptions workbook.
