# Implement the disaster recovery plan Completeness Audit

Audits implement the disaster recovery plan records for completeness and policy compliance against rule-based checks.
...
Reads implement the disaster recovery plan records, runs a rule-based completeness audit, and emits an exceptions workbook.
