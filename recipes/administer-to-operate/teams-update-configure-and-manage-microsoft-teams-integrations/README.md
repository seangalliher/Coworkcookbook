# Configure and manage Microsoft Teams integrations Teams Channel Update

Drafts a Teams channel post on configure and manage Microsoft Teams integrations status with an interactive Adaptive Card for quick triage.
...
Reads configure and manage Microsoft Teams integrations, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Configure and manage Microsoft Teams integrations Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
