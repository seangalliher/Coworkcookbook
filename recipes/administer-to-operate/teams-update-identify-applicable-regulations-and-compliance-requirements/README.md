# Identify applicable regulations and compliance requirements Teams Channel Update

Drafts a Teams channel post on identify applicable regulations and compliance requirements status with an interactive Adaptive Card for quick triage.
...
Reads identify applicable regulations and compliance requirements, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Identify applicable regulations and compliance requirements Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
