# Test software releases Summary Report

Builds a structured summary report of test software releases activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where test software releases stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads test software releases records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Test software releases Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
