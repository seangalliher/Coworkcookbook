# Analyze background job performance and history Teams Channel Update

Drafts a Teams channel post on analyze background job performance and history status with an interactive Adaptive Card for quick triage.
...
Reads analyze background job performance and history, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Analyze background job performance and history Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
