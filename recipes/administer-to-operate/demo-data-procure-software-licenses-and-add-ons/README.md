# Procure software licenses and add-ons Demo Data Generator

Generates and creates realistic demo records for procure software licenses and add-ons in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic procure software licenses and add-ons data in minutes.

## What it does

Generates a configurable number of realistic procure software licenses and add-ons records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Procure software licenses and add-ons Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
