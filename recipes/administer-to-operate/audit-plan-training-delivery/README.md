# Plan training delivery Completeness Audit

Audits plan training delivery records for completeness and policy compliance against rule-based checks.
...
Reads plan training delivery records, runs a rule-based completeness audit, and emits an exceptions workbook.
