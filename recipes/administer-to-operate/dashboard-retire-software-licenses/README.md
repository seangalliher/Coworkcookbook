# Retire software licenses Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for retire software licenses - opens in any browser, no D365 access needed by the viewer.
...
Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing retire software licenses.
...
![Placeholder screenshot for Retire software licenses Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
