# Test and validate the business continuity plan Completeness Audit

Audits test and validate the business continuity plan records for completeness and policy compliance against rule-based checks.
...
Reads test and validate the business continuity plan records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Cowork output captured against USMF](screenshots/01-cowork-output.png "Cowork audit output captured 2026-06-04")
