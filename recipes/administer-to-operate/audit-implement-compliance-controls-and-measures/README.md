# Implement compliance controls and measures Completeness Audit

Audits implement compliance controls and measures records for completeness and policy compliance against rule-based checks.
...
Reads implement compliance controls and measures records, runs a rule-based completeness audit, and emits an exceptions workbook.
