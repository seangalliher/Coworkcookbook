# Configure and administer workflows Completeness Audit

Audits configure and administer workflows records for completeness and policy compliance against rule-based checks.
...
Reads configure and administer workflows records, runs a rule-based completeness audit, and emits an exceptions workbook.
