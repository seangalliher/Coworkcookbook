# Update work order details Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on update work order details status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for update work order details reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads update work order details data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Update work order details Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
