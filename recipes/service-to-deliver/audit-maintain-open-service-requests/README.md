# Maintain open service requests Completeness Audit

Audits maintain open service requests records for completeness and policy compliance against rule-based checks.
...
Reads maintain open service requests records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Maintain open service requests Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
