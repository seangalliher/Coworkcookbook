# Coordinate service work with customer Completeness Audit

Audits coordinate service work with customer records for completeness and policy compliance against rule-based checks.
...
Reads coordinate service work with customer records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Coordinate service work with customer Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
