# D365 Develop service strategy Expert

A Dynamics 365 F&SCM expert scoped to the Develop service strategy area (a level-2 subdomain of Service to deliver) - covers 10 L3 processes.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-service-to-deliver-develop-service-strategy/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-service-to-deliver-develop-service-strategy.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/service-to-deliver/d365-service-to-deliver-develop-service-strategy/skill/dist/d365-service-to-deliver-develop-service-strategy.zip)
2. Extract the archive - you get a folder named `d365-service-to-deliver-develop-service-strategy/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-service-to-deliver-develop-service-strategy`.
