# D365 Service to deliver Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Service to deliver end-to-end process - covers 5 L2 areas and 37 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-service-to-deliver/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-service-to-deliver.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/service-to-deliver/d365-service-to-deliver/skill/dist/d365-service-to-deliver.zip)
2. Extract the archive - you get a folder named `d365-service-to-deliver/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-service-to-deliver`.
