...
# d365-service-to-deliver

## When to Use

Activate this skill whenever the user's request touches the **Service to deliver** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
