# Schedule frontline workers Summary Report

Builds a structured summary report of schedule frontline workers activity with totals, trends, and breakdowns.
...
Gives leadership a fast, repeatable view of where schedule frontline workers stands so decisions are made on facts rather than spreadsheet stitches.

## What it does

Reads schedule frontline workers records, computes summary statistics and groupings, and emits an Excel report.
...
![Placeholder screenshot for Schedule frontline workers Summary Report](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
