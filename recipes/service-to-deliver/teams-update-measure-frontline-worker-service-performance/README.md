# Measure frontline worker service performance Teams Channel Update

Drafts a Teams channel post on measure frontline worker service performance status with an interactive Adaptive Card for quick triage.
...
Reads measure frontline worker service performance, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Measure frontline worker service performance Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
