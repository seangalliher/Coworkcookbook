# Gather work order details Status Adaptive Card

Produces a reusable Adaptive Card JSON snapshot of gather work order details status for embedding in dashboards, emails, or Teams.
...
Gives any consuming app (Teams, Outlook, custom dashboard) a single canonical gather work order details status card so different surfaces always show the same numbers.

## What it does

Generates an Adaptive Card JSON file with current gather work order details KPIs and RAG indicators.
...
![Placeholder screenshot for Gather work order details Status Adaptive Card](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
