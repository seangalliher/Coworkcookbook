# Review case loads and rebalance case loads Bulk Field Update

Applies a bulk field update across review case loads and rebalance case loads records from an input list, with dry-run preview before commit.
...
Avoids the click-by-click drudgery (and risk of inconsistency) when review case loads and rebalance case loads records need a coordinated change - and the dry-run preview catches mistakes before they hit the system.
...
![Placeholder screenshot for Review case loads and rebalance case loads Bulk Field Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
