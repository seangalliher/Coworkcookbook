# Create a case manually Configuration Bulk Setup

Applies a bulk configuration change to create a case manually from an input Excel file, with validation and rollback support.
...
Eliminates the click-by-click burden of bulk configuration changes for create a case manually, cutting setup time from days to minutes while preserving auditability.
...
![Placeholder screenshot for Create a case manually Configuration Bulk Setup](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
