# Assign a case Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on assign a case status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for assign a case reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads assign a case data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Assign a case Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
