# Define queues and teams Teams Channel Update

Drafts a Teams channel post on define queues and teams status with an interactive Adaptive Card for quick triage.
...
Reads define queues and teams, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Define queues and teams Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
