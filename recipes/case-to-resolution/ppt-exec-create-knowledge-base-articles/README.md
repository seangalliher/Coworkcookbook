# Create knowledge base articles Executive PowerPoint Deck

Generates an executive-ready PowerPoint deck on create knowledge base articles status, complete with charts and talking-point notes.
...
Cuts deck prep time from hours to minutes for create knowledge base articles reviews while ensuring the numbers in the slides match D365 to the cent.

## What it does

Reads create knowledge base articles data and produces a 6-8 slide PowerPoint suitable for an executive review.
...
![Placeholder screenshot for Create knowledge base articles Executive PowerPoint Deck](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
