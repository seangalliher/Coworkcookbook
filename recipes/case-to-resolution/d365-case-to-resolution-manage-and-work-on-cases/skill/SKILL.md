---
name: d365-case-to-resolution-manage-and-work-on-cases
...
# d365-case-to-resolution-manage-and-work-on-cases

## When to Use

Activate this skill whenever the user's request touches the **Manage and work on cases** area within **Case to resolution**, focused specifically on the Manage and work on cases L2 area. Specific trigger phrases include:
