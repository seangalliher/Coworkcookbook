...
> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Cowork/.claude/skills/d365-case-to-resolution-manage-and-work-on-cases/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
