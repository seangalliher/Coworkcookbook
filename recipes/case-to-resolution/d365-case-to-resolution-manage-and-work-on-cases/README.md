# D365 Manage and work on cases Expert

A Dynamics 365 F&SCM expert scoped to the Manage and work on cases area (a level-2 subdomain of Case to resolution) - covers 17 L3 processes.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-case-to-resolution-manage-and-work-on-cases/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-case-to-resolution-manage-and-work-on-cases.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/case-to-resolution/d365-case-to-resolution-manage-and-work-on-cases/skill/dist/d365-case-to-resolution-manage-and-work-on-cases.zip)
2. Extract the archive - you get a folder named `d365-case-to-resolution-manage-and-work-on-cases/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-case-to-resolution-manage-and-work-on-cases`.
