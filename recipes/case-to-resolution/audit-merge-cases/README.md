# Merge cases Completeness Audit

Audits merge cases records for completeness and policy compliance against rule-based checks.
...
Reads merge cases records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Merge cases Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
