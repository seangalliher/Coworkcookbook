# D365 Case to resolution Expert

A Dynamics 365 Finance & Supply Chain Management expert scoped to the Case to resolution end-to-end process - covers 5 L2 areas and 37 L3 processes from the Microsoft Business Process Catalog.

> ℹ **This is a Cowork custom skill.** Place the contents of the `skill/` folder under `Documents/Cowork/skills/d365-case-to-resolution/` in your OneDrive. Cowork auto-discovers custom skills at the start of each conversation.
...
1. [Download `d365-case-to-resolution.zip`](https://github.com/seangalliher/Coworkcookbook/raw/main/recipes/case-to-resolution/d365-case-to-resolution/skill/dist/d365-case-to-resolution.zip)
2. Extract the archive - you get a folder named `d365-case-to-resolution/` containing `SKILL.md`.
...
3. Create a subfolder named `d365-case-to-resolution`.
