...
# d365-case-to-resolution

## When to Use

Activate this skill whenever the user's request touches the **Case to resolution** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
