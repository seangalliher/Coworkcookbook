# Define case types and policies Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for define case types and policies - opens in any browser, no D365 access needed by the viewer.
...
Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing define case types and policies.
...
![Placeholder screenshot for Define case types and policies Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
