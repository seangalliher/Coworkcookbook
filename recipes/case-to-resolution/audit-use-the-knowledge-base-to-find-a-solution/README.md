# Use the knowledge base to find a solution Completeness Audit

Audits use the knowledge base to find a solution records for completeness and policy compliance against rule-based checks.
...
Reads use the knowledge base to find a solution records, runs a rule-based completeness audit, and emits an exceptions workbook.
...
![Placeholder screenshot for Use the knowledge base to find a solution Completeness Audit](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
