# Engage in conversations with customers Teams Channel Update

Drafts a Teams channel post on engage in conversations with customers status with an interactive Adaptive Card for quick triage.
...
Reads engage in conversations with customers, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Engage in conversations with customers Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
