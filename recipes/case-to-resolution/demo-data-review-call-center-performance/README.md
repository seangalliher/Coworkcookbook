# Review call center performance Demo Data Generator

Generates and creates realistic demo records for review call center performance in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic review call center performance data in minutes.

## What it does

Generates a configurable number of realistic review call center performance records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Review call center performance Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
