# Define sales teams Demo Data Generator

Generates and creates realistic demo records for define sales teams in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic define sales teams data in minutes.

## What it does

Generates a configurable number of realistic define sales teams records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Define sales teams Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
