# Conduct upsell, cross sell or repeat sale prompt Demo Data Generator

Generates and creates realistic demo records for conduct upsell, cross sell or repeat sale prompt in a sandbox tenant for training and pilot scenarios.
...
Eliminates the 'no data to demo with' blocker for trainers, implementation partners, and pilot programs by populating realistic but synthetic conduct upsell, cross sell or repeat sale prompt data in minutes.

## What it does

Generates a configurable number of realistic conduct upsell, cross sell or repeat sale prompt records and creates them via the D365 ERP plugin.
...
![Placeholder screenshot for Conduct upsell, cross sell or repeat sale prompt Demo Data Generator](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
