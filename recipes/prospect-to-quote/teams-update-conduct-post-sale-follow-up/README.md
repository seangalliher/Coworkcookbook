# Conduct post-sale follow-up Teams Channel Update

Drafts a Teams channel post on conduct post-sale follow-up status with an interactive Adaptive Card for quick triage.
...
Reads conduct post-sale follow-up, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Conduct post-sale follow-up Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
