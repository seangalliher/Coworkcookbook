# Establish sales commission and incentive structures Teams Channel Update

Drafts a Teams channel post on establish sales commission and incentive structures status with an interactive Adaptive Card for quick triage.
...
Reads establish sales commission and incentive structures, produces a Communications-ready Teams post + an Adaptive Card with quick-action buttons.
...
![Placeholder screenshot for Establish sales commission and incentive structures Teams Channel Update](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
