# Confirm purchase details Interactive HTML Dashboard

Produces a self-contained interactive HTML dashboard for confirm purchase details - opens in any browser, no D365 access needed by the viewer.
...
Lets ops leadership share a live-looking view of confirm purchase details with executives and customers without granting D365 logins.

## What it does

Builds a single-file HTML dashboard with inline SVG/d3 charts visualizing confirm purchase details.
...
![Placeholder screenshot for Confirm purchase details Interactive HTML Dashboard](screenshots/01-placeholder.svg "Placeholder - replace with a real screenshot captured against your tenant.")
