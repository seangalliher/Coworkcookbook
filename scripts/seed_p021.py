...
RECIPES: List[Recipe] = [
    ...
    Recipe(
        ...
        process_tags=["record-to-report/general-ledger"],
        ootb=["Excel", "Email"],
    ...
    Recipe(
        ...
        process_tags=["record-to-report/journal-validation"],
        ootb=["Excel"],
        plugin_actions=[("dynamics-365-erp", "trial-balance-query")],
        mutates_data=False,
        prompt=(
    ...
    Recipe(
        ...
        process_tags=["record-to-report/period-close"],
    ...
    Recipe(
        ...
        process_tags=["record-to-report/fx-revaluation"],
        ootb=["Excel"],
        plugin_actions=[("dynamics-365-erp", "trial-balance-query")],
        mutates_data=False,
        prompt=(
    ...
    Recipe(
        ...
        process_tags=["source-to-pay/vendor-management"],
        ootb=["Excel"],
    ...
    Recipe(
        ...
        process_tags=["source-to-pay/invoice-validation"],
        ootb=["Excel", "Email"],
    ...
    Recipe(
        ...
        process_tags=["source-to-pay/payment-execution/payment-proposal-review"],
        ootb=["Excel"],
    ...
    Recipe(
        ...
        process_tags=["order-to-cash/collections"],
    ...
    Recipe(
        ...
        process_tags=["order-to-cash/sales-order"],
        ootb=["Excel"],
    ...
    Recipe(
        ...
        process_tags=["order-to-cash/reporting"],
        ootb=["PDF"],
        plugin_actions=[("dynamics-365-erp", "sales-order-query")],
        mutates_data=False,
        prompt=(
    ...
    Recipe(
        ...
        process_tags=["plan-to-produce/bom-management"],
        ootb=["Excel"],
    ...
    Recipe(
        ...
        process_tags=["plan-to-produce/planning"],
        ootb=["Excel"],
        plugin_actions=[("dynamics-365-erp", "bom-query")],
        mutates_data=False,
        prompt=(
    ...
    Recipe(
        ...
        process_tags=["plan-to-produce/production-execution"],
        ootb=["Excel"],
        plugin_actions=[("dynamics-365-erp", "bom-query")],
        mutates_data=False,
        prompt=(
    ...
    Recipe(
        ...
        process_tags=["acquire-to-dispose/fixed-asset-register"],
        ootb=["Excel"],
    ...
    Recipe(
        ...
        process_tags=["acquire-to-dispose/depreciation"],
        ootb=["Excel"],
        plugin_actions=[("dynamics-365-erp", "fixed-asset-query")],
        mutates_data=False,
        prompt=(
    ...
    Recipe(
        ...
        process_tags=["hire-to-retire/reporting"],
        ootb=["Excel"],
        plugin_actions=[],
        mutates_data=False,
        prompt=(
    ...
    Recipe(
        ...
        process_tags=["hire-to-retire/onboarding"],
        ootb=["Word", "Email"],
        plugin_actions=[],
        mutates_data=False,
        prompt=(
