...
# d365-record-to-report-define-accounting-policies

## When to Use

Activate this skill whenever the user's request touches the **Define accounting policies** area within **Record to report**, focused specifically on the Define accounting policies L2 area. Specific trigger phrases include:
