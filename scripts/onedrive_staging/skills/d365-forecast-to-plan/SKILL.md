...
# d365-forecast-to-plan

## When to Use

Activate this skill whenever the user's request touches the **Forecast to plan** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
