---
name: d365-source-to-pay-manage-supplier-relationships
...
# d365-source-to-pay-manage-supplier-relationships

## When to Use

Activate this skill whenever the user's request touches the **Manage supplier relationships** area within **Source to pay**, focused specifically on the Manage supplier relationships L2 area. Specific trigger phrases include:
