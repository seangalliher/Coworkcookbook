---
name: d365-inventory-to-deliver
...
# d365-inventory-to-deliver

## When to Use

Activate this skill whenever the user's request touches the **Inventory to deliver** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
