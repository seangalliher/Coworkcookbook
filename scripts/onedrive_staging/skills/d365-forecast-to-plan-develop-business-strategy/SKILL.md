...
# d365-forecast-to-plan-develop-business-strategy

## When to Use

Activate this skill whenever the user's request touches the **Develop business strategy** area within **Forecast to plan**, focused specifically on the Develop business strategy L2 area. Specific trigger phrases include:
