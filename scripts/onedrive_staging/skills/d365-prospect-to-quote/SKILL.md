...
# d365-prospect-to-quote

## When to Use

Activate this skill whenever the user's request touches the **Prospect to quote** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
