...
Activate this skill whenever the user's request touches the **Record to report** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
