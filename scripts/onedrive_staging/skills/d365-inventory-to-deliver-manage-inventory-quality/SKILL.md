...
# d365-inventory-to-deliver-manage-inventory-quality

## When to Use

Activate this skill whenever the user's request touches the **Manage inventory quality** area within **Inventory to deliver**, focused specifically on the Manage inventory quality L2 area. Specific trigger phrases include:
