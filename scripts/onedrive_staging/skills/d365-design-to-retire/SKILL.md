...
# d365-design-to-retire

## When to Use

Activate this skill whenever the user's request touches the **Design to retire** end-to-end business process, covering every area in this domain. Specific trigger phrases include:
